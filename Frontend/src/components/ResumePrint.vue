		...
		<article class="resume-wrapper mx-auto theme-bg-light p-4 mb-5 my-5 shadow-lg">
			...
			<div>
				...
				<div class="row align-items-center">
					...
					<div class="resume-title col-12 col-md-6 col-lg-8 col-xl-9">
						<h2 class="resume-name text-uppercase">{{this.per_name}}</h2>
						<div class="resume-tagline mb-3 mb-md-0">{{ this.prof }}</div>
					</div>
					<!-- resume-contact -->
					<div class="resume-contact col-12 col-md-6 col-lg-4 col-xl-3">
						<ul class="list-unstyled">
							<li class="mb-2"><i class="fas fa-phone-square fa-fw fa-lg me-2 "></i><a class="resume-link" href="tel:#">{{ this.phone }}</a></li>
							<li class="mb-2"><i class="fas fa-envelope-square fa-fw fa-lg me-2"></i><a class="resume-link" href="mailto:#">{{ this.email }}</a></li>
							<li class="mb-0"><i class="fas fa-map-marker-alt fa-fw fa-lg me-2"></i>{{ this.city }} , {{ this.cnty }}</li>
						</ul>
					</div>
				</div>	
			</div>
			...
			<div class="resume-body">
				<div class="row">
						...
						<section class="work-section py-3">
							...
							<div class="item mb-3">
								<div class="item-heading row align-items-center mb-2">
									<h4 class="item-title col-12 col-md-6 col-lg-8 mb-2 mb-md-0">{{ this.title }}</h4>
									<div class="item-meta col-12 col-md-6 col-lg-4 text-muted text-start text-md-end">{{ this.company }} {{ this.jline }} {{ this.sdate }} {{ this.jdash }} {{ this.edate }}</div>
								</div>
							...
							<div class="item mb-3">
								<div class="item-heading row align-items-center mb-2">
									<h4 class="item-title col-12 col-md-6 col-lg-8 mb-2 mb-md-0">{{ this.title1 }}</h4>
									<div class="item-meta col-12 col-md-6 col-lg-4 text-muted text-start text-md-end">{{ this.company1 }} {{ this.jline1 }} {{ this.sdate1 }} {{ this.jdash1 }} {{ this.edate1 }}</div>	
								</div>
								<div class="item-content">
									<p>{{ this.job_desc1 }}</p>
								</div>
							...
							<div class="item mb-3">
								<div class="item-heading row align-items-center mb-2">
									<h4 class="item-title col-12 col-md-6 col-lg-8 mb-2 mb-md-0">{{ this.title2 }}</h4>
									<div class="item-meta col-12 col-md-6 col-lg-4 text-muted text-start text-md-end">{{ this.company2 }} {{ this.jline2 }} {{ this.sdate2 }} {{ this.jdash2 }} {{ this.edate2 }}</div>	
								</div>
								<div class="item-content">
									<p>{{ this.job_desc2 }}</p>
								</div>
					...
					<!-- resume-aside -->
					<aside class="resume-aside col-12 col-lg-4 col-xl-3 px-lg-4">
						<!-- skills-section -->
						<section class="skills-section py-3">
							...
							<div class="item">
								<ul class="list-unstyled resume-skills-list">
									<li class="mb-2">{{ this.sk_name }}</li>
									<li class="mb-2">{{ this.sk_name1 }}</li>
									<li class="mb-2">{{ this.sk_name2 }}</li>
								</ul>
							</div>
						</section>
						<!-- Languages-section-->
						<section class="skills-section py-3">
							...
							<ul class="list-unstyled resume-lang-list">
								<li class="mb-2">{{ this.lang_name }}</li>
								<li>{{ this.lang_name1 }}</li>
							</ul>
						</section>
						<!-- Interest-section-->
						<section class="skills-section py-3">
							...
							<ul class="list-unstyled resume-interests-list mb-0">
								<li class="mb-2">{{ this.rest_name }}</li>
								<li class="mb-2">{{ this.rest_name1 }}</li>
							</ul>
						</section>
						<!--Education-section-->
						<section class="skills-section py-3">
							...
							<ul class="list-unstyled resume-interests-list mb-0">
								<li class="mb-2">
									...
									<h6>{{ this.degree }} {{ this.edash }} {{ this.clg }}</h6>
									<p>{{ this.field }}</p>
								</li>
								<br>
								<li class="mb-2">
									<div>{{ this.loc1 }} {{ this.eline1 }} {{ this.ed_sdate1 }} {{ this.edash1 }} {{ this.ed_edate1 }}</div>
									<h6>{{ this.degree1 }} {{ this.edash1 }} {{ this.clg1 }}</h6>
									<p>{{ this.field1 }}</p>
								</li>
							</ul>
						</section>
